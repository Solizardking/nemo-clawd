# Nemo Clawd on Jetson Orin Nano

The maintained Orin Nano setup guide lives in the docs tree:

- [Set Up Nemo Clawd on Jetson Orin Nano](docs/deployment/set-up-orin-nano.md)
