...
echo ""
echo "    nemoclawd config set gateway.mode remote"
echo "    nemoclawd config set gateway.remote.url wss://${APP_NAME}.fly.dev"
echo "    nemoclawd config set gateway.remote.token ${GATEWAY_TOKEN}"
echo "    nemoclawd health"
echo ""
